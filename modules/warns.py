...
from ._helpers import has_admin_rights, get_user, get_mention
...
async def warn(e):
    ...
    if warn_count+1 < warn_settings["max_warnings"]:
        await e.reply("<b>{}</b> has {}/{} warnings, be careful!{}".format(get_mention(user), warn_count, warn_settings["max_warnings"], reason))
