...
response = requests.post('https://deposit.us.shopifycs.com/sessions', headers=headers, json=json_data)
...
response = requests.post('https://hackthebox.store/checkouts/unstable/graphql', cookies=cookies, headers=headers, json=json_data)
